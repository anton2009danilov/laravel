        ...
        <div class="card-body">
            ...
            <form enctype="multipart/form-data" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input name="title" value="{{ $news->title ?? old('title') }}" type="text" class="form-control" id="title" placeholder="Заголовок">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="text" class="form-control" id="text" rows="3">{{ $news->text ?? old('text') }}</textarea>
                </div>
                ...
                <div class="form-group form-check">
                    <input @if ($news->isPrivate == 1 || old('isPrivate') == 1) checked @endif type="checkbox" value="1" name="isPrivate" class="form-check-input" id="private">
